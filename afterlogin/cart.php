    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                ...
                <p class="m-0 px-2">-</p>
                <p class="m-0"><a href="cart.php">Cart</a></p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
					...
					<?php
						include 'config.php';
						$sql1 = "SELECT cart.*, addproduct.*, addstock.* FROM cart INNER JOIN addproduct ON cart.id=addproduct.id INNER JOIN addstock on cart.id=addstock.sname where cart.userid='".$_SESSION['newuser']."'";
						$result1 = mysqli_query($con,$sql1);
						$num1=mysqlI_num_rows($result1);
						$sl=0;
						$total=0;
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><?php echo $tot;?></td>
							<form action="#" method="post">
							<input type="text" name="cid[]" value="<?php echo $cid;?>" hidden="true">
							<input type="text" name="id1[]" value="<?php echo $aid; ?>" hidden="true">
                            <td class="align-middle"><button type="submit" name="delete" class="btn btn-sm btn-primary"><i class="fa fa-times"></i></button>
							</form></td>
                        </tr>
						<?php
								}
			...
			if(isset($_POST['delete']))
			{
				...
				$query1="delete from cart where cid='".$cid."'";
