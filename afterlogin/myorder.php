    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                ...
                <p class="m-0 px-2">-</p>
                <p class="m-0"><a href="myorder.php">Order</a></p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row px-xl-5">
            <div class="col-lg-12 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
					...
					<?php
						include 'config.php';
						$sql1 = "SELECT ordertb.orderid,  ordertb.id, ordertb.qty, ordertb.userid, addproduct.id, addproduct.image,  addproduct.pname, addproduct.price, ordertb.orderno, ordertb.paymentmethod, ordertb.deliver,ordertb.esdate FROM ordertb INNER JOIN addproduct ON ordertb.id=addproduct.id where ordertb.userid='".$_SESSION['newuser']."' and ordertb.paymentmethod='cash_on_delivery' group by ordertb.orderno";
						$result1 = mysqli_query($con,$sql1);
						$num1=mysqlI_num_rows($result1);
						$sl=0;
						$total=0;
						...
						<td class="align-middle"><?php echo $orderno; ?></td>
                            <td class="align-middle"><a  href="vieworder.php ?vid=<?php echo $orderno; ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a></td>
