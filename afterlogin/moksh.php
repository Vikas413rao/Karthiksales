	...
	if(isset($_GET['uid']))
					{
						$uid=$_GET['uid'];
								...
								include 'config.php';
								$sql1 = "select * from addbrand where id='".$uid."'";
								$result1 = mysqli_query($con,$sql1);
								$num1=mysqlI_num_rows($result1);
								$sl=0;
								if($num1 > 0)
        ...
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3"><?php echo $bname; ?></h1>
                  ...
                  <?php
					if(isset($_GET['uid']))
					{
						$uid1=$_GET['uid'];
								...
								include 'config.php';
								$sql1 = "select * from addproduct where brand='".$uid1."'";
								$result1 = mysqli_query($con,$sql1);
								$num1=mysqlI_num_rows($result1);
								$sl=0;
								if($num1 > 0)
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        ...
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="../admin/product/<?php echo $image; ?>"  style="height:380px;" alt="">
                            </div>
