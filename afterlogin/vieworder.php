...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">View Order</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="index.php">Home</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0"><a href="vieworder.php">View Order</a></p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
					...
					if(isset($_GET['vid']))
  {
	  $vid=$_GET['vid'];
						...
						include 'config.php';
						$sql1 = "SELECT ordertb.*, addproduct.*, address.* FROM ordertb INNER JOIN addproduct ON ordertb.id=addproduct.id INNER JOIN address on ordertb.userid=address.userid and ordertb.paymentmethod='cash_on_delivery' where ordertb.orderno='".$vid."'";
						$result1 = mysqli_query($con,$sql1);
						$num1=mysqlI_num_rows($result1);
						$sl=0;
						$total=0;
