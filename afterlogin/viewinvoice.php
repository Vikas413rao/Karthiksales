...
<body>
    ...
    <!-- Navbar Start -->
    <d<div class="container-fluid mb-5">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
							 ...
							 <a href="viewinvoice.php" class="nav-item nav-link active">View Invoice</a>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">View invoice</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="index.php">Home</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0"><a href="viewinvoice.php">Invoice</a></p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row px-xl-5">
            <div class="col-lg-12 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
					...
					<?php
						include 'config.php';
						$sql1 = "SELECT ordertb.orderid,  ordertb.id, ordertb.qty, ordertb.userid, addproduct.id, addproduct.image,  addproduct.pname, addproduct.price, ordertb.orderno, ordertb.paymentmethod FROM ordertb INNER JOIN addproduct ON ordertb.id=addproduct.id where ordertb.userid='".$_SESSION['newuser']."' and ordertb.paymentmethod='cash_on_delivery' group by ordertb.orderno";
						$result1 = mysqli_query($con,$sql1);
						$num1=mysqlI_num_rows($result1);
						$sl=0;
						$total=0;
						if($num1 > 0)
							{ 
								...
								?>
                        <tr>
						<td class="align-middle"><?php echo $orderno; ?></td>
                            <td class="align-middle"><img src="../admin/product/<?php echo $image; ?>" alt="" style="width: 50px;"> <?php echo $pname; ?></td>
                            ...
                            <td class="align-middle"><a href="invoice.php?iid=<?php echo $orderno; ?>" class="btn btn-sm btn-primary">View Invoice</a>
							</td>
                        </tr>
						<?php
								}
