...
echo "<script> location.href='../brforelogin/login.php'; </script>";
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                ...
                <p class="m-0 px-2">-</p>
                <p class="m-0"><a href="detail.php">Details</a></p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
		...
		if(isset($_GET['cid']))
{
	     $cid=$_GET['cid'];
								include 'config.php';
								$sql1 = "SELECT addproduct.id,addproduct.brand,addproduct.pname,addproduct.image,addproduct.price,addproduct.Description,addstock.quantity,addstock.id FROM addstock INNER JOIN addproduct ON addproduct.id=addstock.sname where addproduct.id='".$cid."'";
								$result1 = mysqli_query($con,$sql1);
								$num1=mysqlI_num_rows($result1);
								$sl=0;
								if($num1 > 0)
            ...
            <div class="col-lg-5 pb-5">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100" src="../admin/product/<?php echo $image;?>" alt="Image" style="height:500px;width:30px;">
                        </div>
                    </div>
                </div>
            </div>
               ...
               <br>
                <h5 class="font-weight-semi-bold mb-4">₹.<?php echo $price; ?></h5>
                <p class="mb-4"><?php echo $Description; ?></p>
				 <p class="mb-4">Available Quantity&nbsp;:-&nbsp;<b><?php echo $quantity; ?></b></p>
				 <?Php if($quantity<=0) {
					?>
					<p>Out of Stock</p>
				<?php } else { ?>
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <input type="number" name="qty" class="form-control bg-secondary text-center" min="1" max="<?php echo $quantity; ?>" value="1">
                        
                    </div>
			
					<input type="text" name="id1[]" value="<?php echo $asid; ?>" hidden="true">
					<input type="text" name="id2[]" value="<?php echo $apid; ?>" hidden="true">
                    <button name="cart" type="submit" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                </div>
					<?php } ?>
				</form>
				<?php
				...
				$qty=$_POST['qty'];
				$query= "insert into cart(id,qty,userid) values('".$id2."','".$qty."','".$_SESSION['newuser']."')";
				mysqli_query($con,$query) or die(mysqli_error($con));
				
				$query1= "update addstock set quantity=quantity-'".$qty."' where id='".$id1."'";
				...
				<?php
                    ...
                    <div class="card product-item border-0">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img class="img-fluid w-100" src="../admin/product/<?php echo $image; ?>" style="height:250px;width:10px;" alt="">
                        </div>
                        ...
                        <div class="card-footer d-flex justify-content-center bg-light border">
                            <a href="detail.php?cid=<?php echo $id;?>" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                 <p class="mb-md-0 text-center text-md-left text-dark">
                    &copy; <a class="text-dark font-weight-semi-bold" href="#">Karthik Sales</a>. All Rights Reserved. Designed
                    by
