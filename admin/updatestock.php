    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" style="background-color:#e4e4e4" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="bill.php">
	  ...
	  <?php
									...
									include 'config.php';
									$sql1 = "select * from addstock where id='".$cid."'";
                ...
                <div class="card-body">
                  <form class="forms-sample" method="post" action="#"  enctype="multipart/form-data">
					...
					<h3>Add Stock</h3>
                      ...
                      <input type="text" class="form-control" name="sname" value="<?php echo $pname;?>"id="exampleInputUsername1" placeholder="Stock name">
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                      ...
                      <input type="text" name="quantity" class="form-control" value="<?php echo $quantity;?>" id="exampleInputEmail1" placeholder="Quantity">
                    </div>
...
if(isset($_POST['ADD']))
{
	...
	include("config.php");
		...
		$quantity=$_POST['quantity'];
			...
			$query ="update addstock set sname='".$sname."',date='".$date."',quantity='".$quantity."' where id='".$cid."'";
