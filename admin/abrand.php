                ...
                <div class="card-body">
                  <form class="forms-sample" method="post" action="#" >
					...
					<h3>Add Brand</h3>
                      ...
                      <input type="text" name="bname" class="form-control" pattern="[A-Za-z\s]+" "[A-Za-z0-9\s]+" title="letters only" id="exampleInputUsername1" placeholder="Brand name">
                    </div>
...
if(isset($_POST['ADD']))
{
	...
	include("config.php");
		...
		$query = "INSERT INTO addbrand(bname)VALUES('".$bname."')";
		...
		echo "<script>
			...
			echo "<script> location.href='abrand.php'; </script>";
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
					  ...
					  <?php
                        ...
                        <tr>
                          <td> <?php echo $sl; ?></td>
                          <td> <?php echo $id; ?>&nbsp;-&nbsp;<?php echo $bname; ?></td>
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from addbrand where id='".$selectano."'";
