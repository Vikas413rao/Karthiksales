                ...
                <div class="card-body">
                  <form  method="post" action="#" enctype="multipart/form-data">
					...
					<h3>Add Product</h3>
					 ...
					 <label for="exampleInputUsername1"><h4>Brand Name</h4></label>
					...
					<div class="form-group">
                      ...
                      <input type="text" name="pname" pattern="[A-Za-z\s]+" "[A-Za-z0-9\s]+" title="only letters" required class="form-control" id="exampleInputUsername1" placeholder="Brand name">
                    </div>
					...
					<div class="form-group">
                      ...
                      <input type="text" name="price"  pattern="[0-9]+" title="numbers only" class="form-control" id="exampleInputEmail1" placeholder="Prize">
                    </div>
					<div class="form-group">
...
if(isset($_POST['ADD']))
{
	...
	include("config.php");
		...
		{
			$query ="INSERT INTO addproduct(image,brand,pname,price,Description) VALUES('".$filename."','".$brand."','".$pname."','".$price."','".$Description."')";
